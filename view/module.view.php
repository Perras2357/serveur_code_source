        ...
        <div class="container">
            ...
            <div class="row g-3 mb-5 ">
                ...
                <?php
                    ...
                    {
                        if (gettype($contenu_liste_module)=='array')//si la requette renvoie un tableau d'élément (Plusieurs module on été créée)
                        {
                ...
                ?> 
                                <div class="col-lg-2 col-md-4 offset-lg-1 offset-md-1">
                                    <div class="card shadow-lg contenu h-100">
                                        <a id="module" href="module.php?id_operateur=<?=$_SESSION["id_operateur"];?>&id_projet=<?=$_GET["id_projet"];?>&id_module=<?=$element_liste_module -> id_module;?>">
                ...
                <?php
                        ...
                        if(gettype($contenu_liste_module)=='object')//si la quette renvoie un seul élément (objet) alors il y'a juste un module dans la bd
                        {
                            //var_dump($contenu_liste_module -> nom_module);

                ?>
                            <div class="col-lg-2 col-md-4 offset-lg-1 offset-md-1">
                                <div class="card shadow-lg contenu h-100">
                                    <a id="module" href="module.php?id_operateur=<?=$_SESSION["id_operateur"];?>&id_projet=<?=$_GET["id_projet"];?>">
                                        <img  src="img/module.jpeg" alt="module" class="img_nav col-lg-12 col-md-12" >
                                        <div class="card-body">
                                            <div class="parag py-3">
                                                <h6 class="text-center"><?=$contenu_liste_module->nom_module;?></h6>
                                            </div>
                                        </div><!-- card-body -->
                                    </a>
                                </div><!-- card -->
